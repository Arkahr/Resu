                     ...
                     switch (actor.FloorCoordinate.ToString())
                            {
                              ...
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(1700.923f, 633.282f, 0.1f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(1715.711f, 637.723f, 0.1f, false, false);
                              break;
                              
                              case "1532.000, 558.000, 0.0":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(1531.762f, 599.938f, 0.1f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(1516.049f, 594.653f, 0.1f, false, false);
                              break;
                              
                              case "1730.000, 1284.000, -20.0":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(1729.562f, 1233.752f, -19.8f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(1713.666f, 1236.566f, -19.8f, false, false);
                              break;
                              
                              case "565.000, 752.500, -30.0":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(603.371f, 740.587f, -29.9f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(597.649f, 725.779f, -29.9f, false, false);
                              break;
                              
                              case "585.000, 800.000, -29.4":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(620.953f, 781.000f, -29.6f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(609.879f, 766.239f, -29.6f, false, false);
                              break;
                              
                              case "625.000, 847.500, -29.1":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(636.387f, 803.288f, -29.6f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(651.761f, 817.361f, -29.6f, false, false);
                              break;
                              
                              case "715.000, 547.500, -19.8":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(673.938f, 552.332f, -19.8f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(670.547f, 539.062f, -19.2f, false, false);
                              break;
                              
                              case "807.500, 550.000, -29.2":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(806.216f, 518.899f, -29.3f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(818.463f, 525.613f, -29.3f, false, false);
                              break;
                              
                              case "665.000, 765.000, -69.6":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(690.322f, 791.526f, -69.9f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(696.963f, 781.937f, -69.9f, false, false);
                              break;
                              
                              case "1376.000, 792.000, 0.1":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(1361.278f, 749.009f, 0.1f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(1377.149f, 749.373f, 0.1f, false, false);
                              break;
                              
                              case "1182.500, 1132.500, -10.0":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(1182.970f, 1075.510f, -9.9f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(1161.672f, 1091.661f, -9.9f, false, false);
                              break;
                              
                              case "1473.510, 691.200, 0.1":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(1508.859f, 669.130f, 0.1f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(1511.500f, 691.192f, 0.1f, false, false);
                              break;
                              
                              case "1122.936, 549.417, 0.0":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(1151.337f, 575.905f, 0.1f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(1139.722f, 587.115f, 0.1f, false, false);
                              break;
                              
                              case "339.276, 906.676, 0.0":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(365.023f, 932.040f, 0.1f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(350.773f, 940.882f, 0.1f, false, false);
                              break;
                              
                              case "213.000, 1135.000, 0.6":
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(243.265f, 1109.739f, 0.7f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(254.062f, 1134.910f, 0.7f, false, false);
                              break;
                              ...
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(674.027f, 612.886f, 0.8f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(657.211f, 620.335f, 0.8f, false, false); 
                              break;
                              
                              case "635.000, 762.000, -10.0": 
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(660.533f, 738.268f, -9.9f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(664.457f, 751.970f, -10.9f, false, false); 
                              break;
                              
                              case "1730.000, 1764.000, -20.0": 
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(1737.904f, 1719.187f, -19.9f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(1719.671f, 1718.834f, -19.7f, false, false); 
                              break; 

                              case "1127.000, 1744.000, 10.0": 
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(1133.214f, 1784.894f, 10.1f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(1118.811f, 1776.153f, 10.9f, false, false); 
                              break; 

                              case "1340.000, 1775.000, 0.0": 
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(1328.011f, 1732.206f, 0.1f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(1347.369f, 1732.206f, 0.1f, false, false); 
                              break; 
                               
                              case "1673.000, 1673.000, 0.1": 
                              worldCoord1 = Hud.Window.WorldToScreenCoordinate(1686.445f, 1714.270f, 0.1f, false, false); 
                              worldCoord2 = Hud.Window.WorldToScreenCoordinate(1700.836f, 1698.847f, 0.1f, false, false); 
                              break; 
